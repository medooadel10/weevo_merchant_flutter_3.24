...
class ShipmentDetailsWithOneProduct extends StatefulWidget {
  ...
  State<ShipmentDetailsWithOneProduct> createState() =>
      _ShipmentDetailsWithOneproducts();
}

class _ShipmentDetailsWithOneproducts
    extends State<ShipmentDetailsWithOneProduct> {
  late AuthProvider authProvider0;
  final Preferences preferences = Preferences.instance;
  String? shareLink;
  @override
  void initState() {
    super.initState();
    authProvider0 = Provider.of<AuthProvider>(context, listen: false);
    createDynamicLink(widget.shipmentId);
  }
  ...
  Widget build(BuildContext context) {
    ...
    log('displayShipmentProvider.shipmentById!.courierId -> ${displayShipmentProvider.shipmentById!.status}');
          ...
          appBar: AppBar(
                    ...
                    ? GestureDetector(
                        onTap: () {
                          Navigator.pushReplacementNamed(
                            ...
                            arguments: ShipmentNotification(
                                ...
                                receivingCity:
                                    data.shipmentById!.receivingCity!,
                                deliveryCity:
                                    data.shipmentById!.deliveringCity!,
                                childrenShipment: 0,
                                deliveryState:
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            color: preferences.getWeevoShipmentOfferCount(
                          ...
                          child: Row(
                            children: [
                              Text(
                                preferences.getWeevoShipmentOfferCount(
                                            data.shipmentById!.id.toString()) <=
                                        0
                                    ? 'في انتظار العروض'
                                    : 'لديك ${preferences.getWeevoShipmentOfferCount(data.shipmentById!.id.toString())} عرض',
            ...
            leading: IconButton(
              ...
              onPressed: () {
                ...
                } else if (authProvider0.fromOutsideNotification) {
                  authProvider0.setFromOutsideNotification(false);
                            ...
                            children: [
                              ClipOval(
                                child: SizedBox(
                                  height: 60.h,
                                  width: 60.w,
                                  child: data.shipmentById!.courier!.photo !=
                                              null &&
                                          data.shipmentById!.courier!.photo!
                                              .isNotEmpty
                                      ? CustomImage(
                                          imageUrl:
                                              data.shipmentById!.courier!.photo,
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      //         });
                                      //         if (data.shipmentById!.products![0]
                                      //             .productInfo.image.isNotEmpty) {
                                      //           var request = await HttpClient()
                                      //               .getUrl(Uri.parse(data
                                      //                   .shipmentById
                                      //                   .products![0]
                                      //                   .productInfo
                                      //                   .image));
                                  ...
                                  Text(
                                    data.shipmentById!.products![0].productInfo!
                                            .description ??
                                        '',
                                    style: TextStyle(
                                      fontSize: 11.0.sp,
                              ...
                              data.shipmentById!.products![0].productInfo!
                                  ...
                                  ? Row(
                                      children: [
                                        ...
                                        Text(
                                          '${data.shipmentById!.products![0].productInfo!.productCategory!.name}',
                                          style: TextStyle(
                                            fontSize: 12.0.sp,
                                          ),
                                        )
                                        ...
                                        onTap: () async {
                                          ...
                                          Navigator.pushNamed(
                                              ...
                                              arguments: ShipmentTrackingModel(
                                                  courierNationalId:
                                                      courierNationalId,
                                                  merchantNationalId: authProvider
                                                      .getNationalId,
                                                  shipmentId:
                                                      data.shipmentById!.id,
                                                  ...
                                                  clientPhone: data
                                                      ...
                                                      .clientPhone,
                                                  hasChildren:
                                                      data.shipmentById!.parentId! == 0 ? 0 : 1,
                                                  status: data.shipmentById!.status,
                                                  deliveringLng: data.shipmentById!.deliveringLng,
                                                  receivingLng: data.shipmentById!.receivingLng,
                                                  receivingLat: data.shipmentById!.receivingLat,
  ...
  Future<void> createDynamicLink(int shipmentId) async {
  ...
  Future<void> cancelShippingCallback(
    ...
    showDialog(
        ...
        builder: (_) => CancelShipmentDialog(onOkPressed: () async {
              ...
              log('ShipmentId : ${data.shipmentById!.id}');
              showDialog(
                  context: navigator.currentContext!,
                  barrierDismissible: false,
