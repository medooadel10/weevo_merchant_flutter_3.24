import 'payment_status_plan.dart';

class PaymentStatusSubscription {
  int? id;
  ...
  PaymentStatusSubscription.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    plan = json['plan'] != String
        ? PaymentStatusPlan.fromJson(json['plan'])
        : null;
  }
